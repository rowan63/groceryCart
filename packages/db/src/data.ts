...
export const products: Product[] = [
  ...
  { name: "Beef Mince", description: "500g lean beef mince", price: 8.99, imageUrl: "https://static.vecteezy.com/system/resources/thumbnails/038/978/480/small_2x/ai-generated-raw-ground-beef-in-a-black-plastic-tray-isolated-on-transparent-background-png.png", category: "meat-seafood", subcategory: "Beef", stock: 30, active: true },
  { name: "Lamb Chops", description: "Fresh lamb chops", price: 15.99, imageUrl: "https://i.postimg.cc/j24jWB77/vecteezy-lamb-chops-on-a-transparent-background-36162056.png", category: "meat-seafood", subcategory: "Lamb", stock: 20, active: true },
  { name: "Atlantic Salmon", description: "Fresh Atlantic salmon fillet", price: 18.99, salePrice: 14.99, onSpecial: true, imageUrl: "https://i.postimg.cc/vZcQM43y/fresh-atlantic-salmon-fillet-isolated-on-transparent-background-healthy-seafood-free-png.webp", category: "meat-seafood", subcategory: "Seafood", stock: 25, active: true },
  ...
  { name: "Strawberries", description: "250g punnet of strawberries", price: 4.99, salePrice: 3.49, onSpecial: true, imageUrl: "https://static.vecteezy.com/system/resources/previews/008/541/753/non_2x/strawberries-basket-transparent-png.png", category: "fruit-veg", subcategory: "Fruit", stock: 60, active: true },
  ...
  { name: "Free Range Eggs", description: "Dozen free range eggs", price: 6.99, salePrice: 5.49, onSpecial: true, imageUrl: "https://png.pngtree.com/png-vector/20250606/ourmid/pngtree-chicken-eggs-isolated-on-transparent-background-png-image_16464753.png", category: "dairy-fridge", subcategory: "Eggs", stock: 55, active: true },
